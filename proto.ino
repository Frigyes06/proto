...
index index = { 16, 24, 32, 40, 0, 8, 48, 64, 72, 80, 88, 96, 104, 56};

//Right side of the helmet
char noseRight[] =  {8, 8, B00000000, B00000000, B00000001, B00000011, B00000011, B00111111, B01111110, B00000000};
...
char O1 [] =        {8, 8, B11110000, B00111100, B00001110, B00000011, B00000011, B00001110, B00111100, B11110000};
char O2 [] =        {8, 8, B00001111, B00111100, B01110000, B11000000, B11000000, B01110000, B00111100, B00001111};
char X2 [] =        {8, 8, B11110000, B00111100, B00001110, B00000011, B00000011, B00001110, B00111100, B11110000};
char X1 [] =        {8, 8, B00001111, B00111100, B01110000, B11000000, B11000000, B01110000, B00111100, B00001111};
char Confused1 [] = {8, 8, B00001000, B00000000, B00001000, B00111000, B00100010, B00100010, B00100010, B00111110};
char Confused2 [] = {8, 8, B00010000, B00000000, B00010000, B01110000, B01000100, B01000100, B01000100, B01111100};
char Heart2 [] =    {8, 8, B00000001, B00000010, B00000100, B00000100, B00001000, B00001001, B00001001, B00000110};
char Heart1 [] =    {8, 8, B10000000, B01000000, B00100000, B00100000, B00100000, B10010000, B10010000, B01100000};
char Blank [] =     {8, 8, B00000000, B00000000, B00000000, B00000000, B00000000, B00000000, B00000000, B00000000};
char Sans [] =      {8, 8, B00000000, B00001000, B00011100, B00110110, B00110110, B00011100, B00001000, B00000000};
char a1 [] =         {8, 8, B10101001, B10101001, B10101001, B10101001, B10101001, B10101001, B10101001, B10101001};
char a2 [] =         {8, 8, B01000000, B01000000, B01000000, B01000000, B01000000, B01000000, B01000000, B01000000};
char a3 [] =         {8, 8, B01000010, B01000010, B01000010, B01000010, B01000010, B01000010, B01000010, B01000010};
char a4 [] =         {8, 8, B10010010, B10010010, B10010010, B10010010, B10010010, B10010010, B10010010, B10010010};
char a5 [] =         {8, 8, B00010000, B00010000, B00010000, B00010000, B00010000, B00010000, B00010000, B00010000};
char a6 [] =         {8, 8, B00010101, B00010101, B00010101, B00010101, B00010101, B00010101, B00010101, B00010101};
char a7 [] =         {8, 8, B10001010, B10001010, B10001010, B10001010, B10001010, B10001010, B10001010, B10001010};
char a8 [] =         {8, 8, B01001010, B01001010, B01001010, B01001010, B01001010, B01001010, B01001010, B01001010};
char Devil1 [] =     {8, 8, B11000001, B10000000, B00000000, B00000000, B00000000, B00000000, B10000000, B11000000};
char Devil2 [] =     {8, 8, B11011100, B01001001, B01001001, B01001001, B01001001, B01001001, B01001001, B01011101};
char Devil3 [] =     {8, 8, B10011100, B01000101, B01000101, B01000101, B01001101, B01000101, B01000101, B01011100};
char Devil4 [] =     {8, 8, B11100011, B00100001, B00100000, B00100000, B00100000, B00100000, B00100001, B11100011};

//Left side of the helmet
char noseLeft[] =   {8, 8, B00000000, B00000000, B10000000, B11000000, B11000000, B11111100, B01111110, B00000000};
...
char TongueOut01[] = {8, 8, B00000000, B00000000, B00000011, B00111111, B00000010, B00000010, B00000010, B00000001};
...
void setup() {                        //starting up sequence
  ...
  m.init();
  m.setIntensity(5);   // You can change the brightness of the matrices within a range of 0-15
  m.clear();
  ...
  attachInterrupt(digitalPinToInterrupt(5), hallSensor, CHANGE);
  if (digitalRead(5) == 0) {
    state2 = 1;
  }
#endif
  ...
  if (state2 == 1) {                 //The Hall sensor Detects wheter the visor is attached, only then will the leds turn on
    ...
    switch (state) {                      //First button press: Happy expression
      ...
      m.writeSprite(88, 0, icon01L);          
        ...
        m.writeSprite(104, 0, Blank);
        m.writeSprite(96, 0, Blank);
        m.writeSprite(8, 0, Sans);
        m.writeSprite(0, 0, Blank);
        m.writeSprite(40, 0, Devil4);
        m.writeSprite(32, 0, Devil3);
        m.writeSprite(24, 0, Devil2);
        m.writeSprite(16, 0, Devil1);
        m.writeSprite(88, 0, Devil4);         
        m.writeSprite(80, 0, Devil3);
        m.writeSprite(72, 0, Devil2);
        m.writeSprite(64, 0, Devil1);
        delay(450);
       
        m.writeSprite(104, 0, X1);
        m.writeSprite(96, 0, X2);
        m.writeSprite(8, 0, X1);
        m.writeSprite(0, 0, X2);
        break;
        
      case 1:
        //Icons for the mouth and nose are being turned on here
        m.writeSprite(88, 0, icon01L);     //Left mouth panels 
        m.writeSprite(80, 0, icon02L);
        m.writeSprite(72, 0, icon03L);
        m.writeSprite(64, 0, icon04L);
        m.writeSprite(56, 0, noseLeft);    //Left nose
        m.writeSprite(48, 0, noseRight);   //Right nose

        m.writeSprite(40, 0, icon04);     //Right mouth panels
        m.writeSprite(32, 0, icon03);
        m.writeSprite(24, 0, icon02);
        m.writeSprite(16, 0, icon01);
        m.writeSprite(104, 0, Eye01L);    //Left eye panels
        m.writeSprite(96, 0, Eye02L);
        m.writeSprite(8, 0, Eye02);       //Right eye panels
        m.writeSprite(0, 0, Eye01);       
      ...
      case 2:                             //Second button press: Surprised
        m.writeSprite(88, 0, icon01L);          //Icons for the mouth and nose are being turned on here
        m.writeSprite(80, 0, icon02L);
        m.writeSprite(72, 0, icon03L);
        m.writeSprite(64, 0, icon04L);
      ...
      case 3:                             //Third button press: Angry expression
      ...
      case 4:
        m.writeSprite(104, 0, O1);
        m.writeSprite(96, 0, O2);
        m.writeSprite(8, 0, O1);
        m.writeSprite(0, 0, O2);
        setColor(0, 0, 8);
        break;
      case 10:
        break;
      ...
      case 6:
        m.writeSprite(104, 0, Confused2);
        m.writeSprite(96, 0, Confused1);
        m.writeSprite(8, 0, Confused2);
        m.writeSprite(0, 0, Confused1);
        break;

      case 7:
        m.writeSprite(104, 0, Heart1);
        m.writeSprite(96, 0, Heart2);
        m.writeSprite(8, 0, Heart1);
        m.writeSprite(0, 0, Heart2);
        break;
